...
\begin{abstract}
    ...
    This paper formulates a theoretical model of two-sided matching within SBDPs, where agents with heterogeneous preferences search for multiple romantic partners whilst facing intertemporal action constraints.
